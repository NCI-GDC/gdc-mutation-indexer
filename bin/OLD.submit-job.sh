...
REVISION=$(git rev-parse HEAD) # NOTE: pass this too
...
exec $SPARK_HOME/bin/spark-submit \
    ...
    --py-files dist/gdc_mutation_indexer-0.1.0_rev_$REVISION-py2.7.egg,$EGGS \ # NOTE: special
    --jars $JARS \ # NOTE: special
    # S3Args
    ...
    # --conf spark.yarn.appMasterEnv.SOURCE_ES_HOST="${SOURCE_ES_HOST:-$ES_HOST}" \ # NOTE: figure this out
