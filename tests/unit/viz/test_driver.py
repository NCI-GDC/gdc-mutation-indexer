...
def patch_build_method() -> (
    Iterator[
        Mapping[type[Union[builders.Builder, builders.BaseBuilder]], mock.MagicMock]
    ]
):
    index_builders = (
...
def test__run__calls_all_builders(
    patch_build_method: Mapping[
        type[Union[builders.Builder, builders.BaseBuilder]], mock.MagicMock
    ]
) -> None:
