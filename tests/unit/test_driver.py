...
class TestDriver(unittest.TestCase):
    def test__get_viz_builders__all_builders(self) -> None:
        ...
        assert isinstance(
            generic_builders[build.DataFrame.ASCAT], builders.ASCATBuilder
        )
        assert isinstance(
            generic_builders[build.DataFrame.ASCAT_METADATA],
    ...
    def test__get_ge_builders__all_builders(self) -> None:
    ...
    def test__get_ge_builders__excludes(self) -> None:
        config = mock.MagicMock()
