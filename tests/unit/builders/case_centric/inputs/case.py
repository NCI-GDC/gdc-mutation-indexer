...
class Case:
    ...
    class File:
        ...
        class Analysi:
            ...
            class InputFile:
                ...
                file_name: None | (str) = "nationwidechildrens.org_ssf_tumor_samples_brca.txt"
                file_size: int | None = 353327
                imaging_date: str | None = None
                magnification: float | None = None
                md5sum: str | None = "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm"
            ...
            class Metadatum:
                ...
                class ReadGroup:
                    ...
                    class ReadGroupQc:
                        ...
                        created_datetime: None | (str) = "2018-05-21T16:07:40.645885-05:00"
                        ...
                        updated_datetime: None | (str) = "2018-11-01T15:06:10.843096-05:00"
                        workflow_end_datetime: str | None = None
                        workflow_link: None | (
                            str
                        ) = "https://github.com/NCI-GDC/somatic-maf-cwl"
                        workflow_start_datetime: str | None = None
                        workflow_type: None | (str) = "MuTect2 Variant Aggregation and Masking"
                    ...
                    target_capture_kit_name: None | (str) = "hg18 nimblegen exome version 2"
                    target_capture_kit_target_region: None | (str) = (
    ...
    class FollowUp:
        ...
        def assert_equals(self, row: sql.Row) -> bool:
            ...
            assert row.comorbidity_method_of_diagnosis == self.comorbidity_method_of_diagnosis
            assert row.created_datetime == self.created_datetime
            ...
            assert (
                row.immunosuppressive_treatment_type == self.immunosuppressive_treatment_type
            )
            ...
            assert (
                row.undescended_testis_corrected_age == self.undescended_testis_corrected_age
            )
            assert (
            ...
            class Analyte:
                ...
                class Aliquot:
                    ...
                    class Center:
                        ...
                        center_type: str | None = "CGCC"
                        code: str | None = "20"
                        name: None | (str) = "MD Anderson - RPPA Core Facility (Proteomics)"
                        namespace: str | None = "mdanderson.org"
                        short_name: str | None = "MDA"
