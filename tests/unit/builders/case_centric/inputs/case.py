...
class Case:
        ...
        class Analysi:
            ...
            class Metadatum:
                ...
                class ReadGroup:
                    ...
                    spike_ins_fasta: str | None = (
                        "https://www.ncbi.nlm.nih.gov/nuccore/9626372?report=fasta"
                    )
                    state: str | None = "released"
                    submitter_id: str | None = "TEST-UNIT-submitter-0"
    ...
    annotations: tuple[Annotation, ...] | None = (Annotation(),)
    case_autocomplete: str | None = None
    case_id: str | None = "case-0"
