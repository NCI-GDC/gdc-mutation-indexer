...
class Transcript:
    ...
    end = attr.ib(type=Optional[int], default=14409)
    ...
    length = attr.ib(type=Optional[int], default=1657)
    ...
    start = attr.ib(type=Optional[int], default=11869)
...
class GeneModel:
    ...
    biotype = attr.ib(type=str, default="protein_coding")
