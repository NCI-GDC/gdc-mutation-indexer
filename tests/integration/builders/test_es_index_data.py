...
from mutation_indexer.es_utils import get_es_doc_count
from tests.integration import config
from tests.integration.utils import json_metrics, true_stats
...
class TestCentricCounts:
    ...
    def test_centric_count(self, doc_type, maf_df, gistic_df, test_data, es_client):
        expected_count = true_stats.TestDataStats.get_stats(
...
@pytest.mark.usefixtures("all_cases", "case_centric_df", "test_data", "es_client")
class TestCaseCentricData:
    ...
    def test_case_centric_summary_stats(self, es_client, maf_stats, stat, all_cases):
        ...
        case_stats = json_metrics.CaseCentricStats(docs)
...
class TestGeneCentricData:
    ...
    def test_gene_centric_summary_stats(self, es_client, maf_stats, stat):
        ...
        gene_stats = json_metrics.GeneCentricStats(docs)
...
class TestSSMCentricData:
    ...
    def test_ssm_centric_summary_stats(self, maf_stats, stat, es_client):
        ...
        ssm_stats = json_metrics.SSMCentricStats(docs)
...
class TestSSMOccurrenceCentricData:
    ...
    def test_ssm_occurrence_centric_summary_stats(self, maf_stats, stat, es_client):
        ...
        ssm_occurrence_stats = json_metrics.SSMOccurrenceCentricStats(docs)
