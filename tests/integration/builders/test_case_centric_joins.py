...
@pytest.mark.usefixtures('sqlContext', 'maf_df', 'cnv_df', 'case_centric_df', 'ssm_transcript_df')
class TestCaseCentricJoins(BaseJoinsTest):
    ...
    def test_genes_per_case(self, maf_df, cnv_df, case_centric_df):
        ...
        df = (
            ...
            .union(cnv_df.select('case_id', 'gene_id'))
        ).distinct()
