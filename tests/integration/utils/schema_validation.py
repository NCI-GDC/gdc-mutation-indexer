class SchemaDataType:
    def __init__(
        self, class_name, fields=tuple(), elementType=None, keyType=None, valueType=None
    ):
...
class PysparkSchemaValidator:
    ...
    def _validate_data_type(self, actual_data_type, expected_data_type, field_name):
        ...
        assert (
            ...
            field_name, actual_name, expected_name
        )
