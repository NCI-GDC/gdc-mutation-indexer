        ...
        return {
            'observation-ssm': {
                ...
                'ssm_occurrence_centric':
                    ['ssm_occurrence_centric', 'properties', 'case',
                     'properties', 'observation'],
                'ssm_score_centric':
                    ['ssm_score_centric', 'properties', 'ssm', 'properties',
                     'observation'],
            },
            'observation-cnv': {
                'gene_centric':
            ...
            'transcript': {
                ...
                'ssm_occurrence_centric': ['ssm_occurrence_centric',
                                           ...
                                           'transcript'],
                'ssm_score_centric': ['ssm_score_centric', 'properties', 'ssm',
                                      'properties', 'consequence',
                                      'properties', 'transcript'],
            },
            'case': {
                ...
                'ssm_occurrence_centric': ['ssm_occurrence_centric',
                                           'properties', 'case'],
                'ssm_score_centric': ['ssm_score_centric',
                                       'properties', 'case'],
            },
            'gene': {
                'case_centric': ['case_centric', 'properties', 'gene'],
    ...
    def exclude_map(self):
        return {
            ...
            'cnv': {
                ...
                'ssm_centric': ['observation'],
                'ssm_occurrence_centric': ['observation'],
                'ssm_score_centric': ['consequence', 'observation'],
            },
            'gene': {
                'gene_centric': ['case'],
