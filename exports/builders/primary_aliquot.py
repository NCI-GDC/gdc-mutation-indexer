...
class PrimaryAliquotBuilder(base_input_builder.BaseInputBuilder):
    ...
    def _add_required_include_fields(
        self, include_fields: Union[Iterable[str], bool]
    ...
    def _get_weighted_entity_df(
        self, weighted_df: sql.DataFrame, entity_id: str, entity: str
    ) -> sql.DataFrame:
    ...
    def _get_primary_aliquot_df(
        ...
        include_fields = self._add_required_include_fields(include_fields)
        ...
        weighted_entity_df = self._combine_weighted_entity_dfs(
