import logging
import itertools
from typing import Iterable, List, Mapping, Optional, TypeVar, NamedTuple
...
GeneExpressionPrimaryAliquotData = NamedTuple(
    ...
    [("primary_aliquot_df", sql.DataFrame), ("file_urls", List[str])],
)
...
class PrimaryAliquotBuilder:
    ...
    def __init__(
        ...
        self.config = config
        self.es_dataframe_util = es_dataframe_util
        self.logger = logger
    ...
    def _get_primary_aliquots(
        ...
        files_df = self.es_dataframe_util.get_dataframe(
            es_utils.Index.File,
