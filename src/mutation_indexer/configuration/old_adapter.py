...
from mutation_indexer.constants import LOG_FORMAT
...
class BaseConfig:
    ...
    def graph_file_index(self) -> str:
        return self._config.elasticsearch.read.indices[constants.IndexType.FILE]

    @property
    def graph_case_index(self) -> str:
        return self._config.elasticsearch.read.indices[constants.IndexType.CASE]
