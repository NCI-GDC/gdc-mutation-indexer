...
class GeneExpressionInputBuilder(bases.BaseInputBuilder, abc.ABC):
...
class GeneExpressionValueInputBuilder(GeneExpressionInputBuilder):
    def __init__(
        self, config, sqlContext, primary_aliquot_builder: viz.PrimaryAliquotBuilder
    ):
        super().__init__(
...
class GeneExpressionBuilder(bases.BaseBuilder):
