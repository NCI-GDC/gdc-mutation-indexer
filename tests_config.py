...
class TestConfig(BaseConfig):
    ...
    def get_env_dict(cls):
        ...
        env_dict = {
            'BUILD_TYPE': 'develop',
            'ES_NODES': os.getenv('ES_NODES_TEST') or 'http://localhost',
            'ES_HOST': os.getenv('ES_HOST_TEST') or 'http://localhost',
            'ES_PORT': '9200',
            'SOURCE_ES_HOST': os.getenv('SOURCE_ES_HOST_TEST') or 'http://localhost',
            'SOURCE_ES_PORT': '9200',
            'S3_HOST': 'fake_s3',
