...
class BaseConfig(object):
    ...
    # Bucket to save final indices to
    s3_index_bucket = 's3a://{}/'.format(os.getenv('S3_INDEX_BUCKET', 'mutation-indexer-raw'))
    ...
    index_paths = {
        'case_centric': s3_index_bucket + 'case-centric.json',
        'gene_centric': s3_index_bucket + 'gene-centric.json',
        'ssm_centric': s3_index_bucket + 'ssm-centric.json',
        'ssm_occurrence_centric': s3_index_bucket + 'ssm-occurrence-centric.json'
    }
